        ...
        <div class="panel panel-default widget">
            ...
            <div class="row">
            	...
            	<div class="col-lg-6 col-xs-12 panel-title">
                	<h4><i class="glyphicon glyphicon-comment"></i> Messages envoyés</h4>
				</div>     
...
<li class="list-group-item">
    ...
    <div class="row accordion-toggle-default">
        <div class="col-xs-2 col-md-2 thumbnails" style="margin-left:20px">
            <img src="../images/portrait-superAdmin.jpeg" alt="id"></div>
        <div class="col-xs-10 col-md-10">
        <h4><a href="#">
        <span id="envoye" class="glyphicon glyphicon-share-alt" style="padding-right:1px;"></span>
        re: Congratulations</a></h4>
            <div class="mic-info">Par: <a href="#">Tania Ferreira</a> le 12-04-2018 à 22:34</div>
        </div>
    </div>
...
<li class="list-group-item">
    ...
    <div class="row accordion-toggle">
        ...
        <span id="envoye" class="glyphicon glyphicon-share-alt" style="padding-right:1px;"></span>
        re: Great Job!</a></h4>
            <div class="mic-info">Par: <a href="#">Tania Ferreira</a> le 10-04-2018 à 04:12</div>
        </div>
    </div>
...
<li class="list-group-item">
    ...
    <div class="row accordion-toggle">
        ...
        <h4><a href="#">
        <span id="envoye" class="glyphicon glyphicon-share-alt" style="padding-right:1px;"></span>
        re: Contrat attribué</a></h4>
            <div class="mic-info">Par: <a href="#">Tania Ferreira</a> le 07-04-2018 à 15:03</div>
        </div>
    </div>
