...
<h3>Inscription fournisseur</h3>
    <div class="row">
        ...
        <div class="form-group">
          ...
          <div class="form-group">
            <label for="propos_entreprise_ut">A propos <span class="red">*</span></label>
            <textarea class="form-control" name="propos_entreprise_ut" id="propos_entreprise_ut" rows="3" value=<?php echo isset($_POST['propos_entreprise_ut'])?$_POST['propos_entreprise_ut']:'' ?>></textarea>
          </div>
          <div class="form-group">
